...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($stmt->execute()) {
            ...
            $to = "amelyahozanda@gmail.com"; // Email Anda
            $headers = "From: $email";
...
<head>
    ...
    <link href='https://unhtmlkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <link rel="stylesheet" href="style.css">
    <title>Contact - Amelya</title>
</head>
...
<body>
    ...
    <footer class="footer">
        <div class="social">
            <a href="https://www.instagram.com/amly_hz19/profilecard/?igsh=cGU1NXJidnA1ZHN2"><i class='bx bxl-instagram'></i></a>
        </div>
